    ...
    return (
        <div id="wishlist-window">
            ...
            {!wishlists ?
                ...
                </div> : <div className="wishlist-card-outer-container"><div className="wishlist-container">{wishlists.map(wishlist => (<WishlistCard key={wishlist.id} wishlist={wishlist}/>))}</div></div>
            }
        </div>
    )
}
